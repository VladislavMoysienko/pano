...
var infospot2 =  new PANOLENS.Infospot(); infospot2.position.set( 5000, 2600, -3400 ); infospot2.addHoverElement( document.getElementById( 'img_2' ), -205 );
var infospot3 =  new PANOLENS.Infospot(); infospot3.position.set( 5000, 2750, -5050 ); infospot3.addHoverElement( document.getElementById( 'img_3' ), -205 );
var infospot4 =  new PANOLENS.Infospot(); infospot4.position.set( 5000, 2900, -6500 ); infospot4.addHoverElement( document.getElementById( 'img_4' ), -205 );
...
var infospot9 =  new PANOLENS.Infospot(); infospot9.position.set( 5000, 650, -3350 );  infospot9.addHoverElement( document.getElementById( 'img_9' ), -75 );
var infospot10 = new PANOLENS.Infospot(); infospot10.position.set( 5000, 650, -5100 ); infospot10.addHoverElement( document.getElementById( 'img_10' ), -75 );
var infospot11 = new PANOLENS.Infospot(); infospot11.position.set( 5000, 800, -6700 ); infospot11.addHoverElement( document.getElementById( 'img_11' ), -75 );
...
var infospot15 = new PANOLENS.Infospot(); infospot15.position.set( -5000, 800, 2250 ); infospot15.addHoverElement( document.getElementById( 'img_15' ), -75 );
var infospot16 = new PANOLENS.Infospot(); infospot16.position.set( -5000, 900, 970 ); infospot16.addHoverElement( document.getElementById( 'img_16' ), -75 );
var infospot17 = new PANOLENS.Infospot(); infospot17.position.set( -5000, 1200, -100 ); infospot17.addHoverElement( document.getElementById( 'img_17' ), -75 );
var infospot18 = new PANOLENS.Infospot(); infospot18.position.set( -5000, 1600, -1000 ); infospot18.addHoverElement( document.getElementById( 'img_18' ), -205 );
...
var infospot23 = new PANOLENS.Infospot(); infospot23.position.set( -5000, 2600, -3900 ); infospot23.addHoverElement( document.getElementById( 'img_23' ), -205 );
var infospot24 = new PANOLENS.Infospot(); infospot24.position.set( -5000, 2500, -2650 ); infospot24.addHoverElement( document.getElementById( 'img_24' ), -205 );
var infospot25 = new PANOLENS.Infospot(); infospot25.position.set( -5000, 2600, -1300 ); infospot25.addHoverElement( document.getElementById( 'img_25' ), -205 );
var infospot26 = new PANOLENS.Infospot(); infospot26.position.set( -5000, 2500, -100 ); infospot26.addHoverElement( document.getElementById( 'img_26' ), -205 );
...
var infospot29 = new PANOLENS.Infospot(); infospot29.position.set( 1300, 450, 7000 ); infospot29.addHoverElement( document.getElementById( 'img_29' ), -75 );
var infospot30 = new PANOLENS.Infospot(); infospot30.position.set( 2300, 550, 7000 ); infospot30.addHoverElement( document.getElementById( 'img_30' ), -75 );
...
var infospot36 = new PANOLENS.Infospot(); infospot36.position.set( 5000, 2800, 3400 ); infospot36.addHoverElement( document.getElementById( 'img_36' ), -205 );
...
var infospot38 = new PANOLENS.Infospot(); infospot38.position.set( 5000, 2200, 2450 ); infospot38.addHoverElement( document.getElementById( 'img_38' ), -205 );
